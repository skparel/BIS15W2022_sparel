...
```{r}
amniota <- readr::read_csv("../lab7/data/amniota.csv")
```
...
The best approach for dealing with NA's in this data set is to replace values of `-999` with `NA`.
