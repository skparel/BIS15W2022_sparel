...
```{r}
fish <- read_csv("C:\\Users\\Owner\\Documents\\GitHub\\BIS15W2022_sparel\\lab3\\data\\Tamburelloetal_HomeRangeDatabase.csv")
```
...
```{r}
mammals <- read_csv("C:\\Users\\Owner\\Documents\\GitHub\\BIS15W2022_sparel\\lab3\\data\\mammal_lifehistories_v2.csv")
```
